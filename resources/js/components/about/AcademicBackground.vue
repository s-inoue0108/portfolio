        ...
        <div class="flex justify-center">
            ...
            <div class="flex flex-col gap-6 px-16">
                ...
                <div class="flex items-center gap-16">
                    ...
                    <div class="flex flex-col gap-3 w-3/4 bg-yellow-400 border-[8px] border-navy-blue rounded-2xl px-8 pt-6">
                        <label class="text-navy-blue text-xl">国立</label>
                        <p class="text-navy-blue text-3xl text-center">東京大学教育学部附属中等教育学校 前期課程</p>
                        <div tabindex="0" class="collapse collapse-arrow">
                            <p class="collapse-title text-navy-blue text-right">詳細を見る</p>
                            <div class="collapse-content text-navy-blue">
                                <div class="flex flex-col gap-4">
                                    <p v-text="secondarySchoolText"></p>
                                    <p class="text-xs text-navy-blue font-light text-center">（欄外をクリックして閉じる）</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="text-center text-yellow-400 text-8xl"><i class="fa-solid fa-chevron-down"></i></div>
    ...
    <div class="flex justify-center px-6 py-24 lg:hidden bg-navy-blue bg-opacity-30">
        <div class="flex flex-col gap-6">
            ...
            <div class="flex flex-col gap-3 bg-yellow-400 border-4 border-navy-blue rounded-2xl px-2 pt-4">
                ...
                <div tabindex="0" class="collapse collapse-arrow">
                    <div class="collapse-title text-right text-navy-blue">詳細を見る</div>
                    <div class="collapse-content text-black">
                        <div class="flex flex-col gap-4">
                            <p v-text="secondarySchoolText"></p>
                            <p class="text-xs text-navy-blue font-light text-center">（欄外をクリックして閉じる）</p>
            ...
            <div class="text-center text-yellow-400 text-5xl"><i class="fa-solid fa-chevron-down"></i></div>
